...
.method private configOrNull(Landroid/content/Context;Lmy1;)Landroidx/emoji2/text/EmojiCompat$Config;
    .locals 1
    ...
    .line 6
    .line 7
    invoke-direct {v0, p1, p2}, Landroidx/emoji2/text/FontRequestEmojiCompatConfig;-><init>(Landroid/content/Context;Lmy1;)V
...
.method private generateFontRequestFrom(Landroid/content/pm/ProviderInfo;Landroid/content/pm/PackageManager;)Lmy1;
    .locals 3
    ...
    .line 18
    .line 19
    invoke-direct {v1, p2, v0, p1, v2}, Lmy1;-><init>(Ljava/util/List;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method public create(Landroid/content/Context;)Landroidx/emoji2/text/EmojiCompat$Config;
    ...
    .line 1
    invoke-virtual {p0, p1}, Landroidx/emoji2/text/DefaultEmojiCompatConfig$DefaultEmojiCompatConfigFactory;->queryForDefaultFontRequest(Landroid/content/Context;)Lmy1;
    ...
    .line 5
    invoke-direct {p0, p1, v0}, Landroidx/emoji2/text/DefaultEmojiCompatConfig$DefaultEmojiCompatConfigFactory;->configOrNull(Landroid/content/Context;Lmy1;)Landroidx/emoji2/text/EmojiCompat$Config;
...
.method public queryForDefaultFontRequest(Landroid/content/Context;)Lmy1;
    .locals 2
    ...
    :cond_0
    :try_start_0
    invoke-direct {p0, v0, p1}, Landroidx/emoji2/text/DefaultEmojiCompatConfig$DefaultEmojiCompatConfigFactory;->generateFontRequestFrom(Landroid/content/pm/ProviderInfo;Landroid/content/pm/PackageManager;)Lmy1;
